...
export function useDraft() {
  ...
  const [draftSettings, setDraftSettings] = useState<DraftSettings | null>(
    null,
  );
  const [isLoading, setIsLoading] = useState(true);

  // Load all persisted data from the database
